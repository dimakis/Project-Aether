    ...
    try:
        if body.helper_type == "input_boolean":
            ...
            return HelperCreateResponse(
                ...
                error=f"Unsupported helper type: {body.helper_type}",
            )
        ...
        return HelperCreateResponse(
            ...
            input_id=body.input_id,
            helper_type=body.helper_type,
            error=sanitize_error(e, context="Create helper"),
        )
...
async def get_registry_summary(
    ...
    try:
        ...
        pass  # Non-critical: summary still works without helpers count
